Filename: 1-5-1-common-encryption-concepts.md
Domain: System and Network Architecture Concepts in Security Operations
Episode: Common Encryption Concepts
=========================================================================
...
+ Secure sockets layer (SSL) inspection
  - Network Device can decrypt/re-encrypt traffic
    + Device can inspect traffic 
      - Looking for sensitive data and/or malicious traffic
        + NGFW
	+ Proxy
