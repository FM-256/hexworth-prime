# CLH Course Transfer Bundle

**Created:** January 16, 2026
**Purpose:** Transfer all files needed to continue CLH course development on another device

---

## QUICK SETUP INSTRUCTIONS

### Step 1: Extract Files from This Bundle

This bundle contains **3 files**. Extract each one to its correct location:

| File | Copy to Location |
|------|------------------|
| `CLH_ISSUES.md` | `[Hexworth Prime]/_planning/CLH_ISSUES.md` |
| `LINUX_LAB_TEMPLATE.md` | `[Hexworth Prime]/_planning/LINUX_LAB_TEMPLATE.md` |
| `LinuxTerminal.js` | `[Hexworth Prime]/_app/components/LinuxTerminal.js` |
...
```
Hexworth Prime/
├── _planning/                    ← Put CLH_ISSUES.md and LINUX_LAB_TEMPLATE.md here
├── _app/
│   ├── components/               ← Put LinuxTerminal.js here (CRITICAL!)
│   └── houses/
│       └── script/
│           └── applets/
│               └── linux/        ← Your CLH lab files should already be here
...
### Step 3: Verify LinuxTerminal.js is Working

The CLH labs import LinuxTerminal.js via:
```html
<script src="../../../components/LinuxTerminal.js"></script>
```

If labs don't work, check:
1. `LinuxTerminal.js` exists at `_app/components/LinuxTerminal.js`
2. The relative path from labs to components is correct (3 levels up)

---

## FILE EXTRACTION GUIDE

Below are the three files. To extract:

1. Find the `========== START: filename ==========` marker
2. Copy everything AFTER the start marker
3. Stop at `========== END: filename ==========`
4. Save to the specified location

---

========== START: CLH_ISSUES.md ==========
SAVE TO: _planning/CLH_ISSUES.md
---
...
========== START: LINUX_LAB_TEMPLATE.md ==========
SAVE TO: _planning/LINUX_LAB_TEMPLATE.md
---
...
========== END: LINUX_LAB_TEMPLATE.md ==========

---

========== START: LinuxTerminal.js ==========
SAVE TO: _app/components/LinuxTerminal.js
---
...
- [ ] `_planning/CLH_ISSUES.md` exists
- [ ] `_planning/LINUX_LAB_TEMPLATE.md` exists
- [ ] `_app/components/LinuxTerminal.js` exists
- [ ] Open any CLH lab (e.g., `clh-002-navigation-recon.html`) in a browser
- [ ] Terminal loads without errors (check browser console)
- [ ] Type `ls` - should show directory contents
- [ ] Type `cd intel` then `ls -la` - should show hidden files

If labs don't work, the most common issue is `LinuxTerminal.js` not being in the right location.

---

## NEXT STEPS (After Transfer)

See `CLH_ISSUES.md` for:
- 8 open issues to fix
- Proposed centralized CLHTerminal.js architecture
- Content guidelines for thematic content

---

*Bundle created: January 16, 2026*
*Total files: 3*
*Total size: ~85KB*
