...
const SignalData = {
    ...
    //   expert — 3+ prerequisites. Capstone tying together an entire
    ...
    // -------------------------------------------------------------------------
    // P6: unified 6-tier ladder shared with the Projects hub (geometric XP, same colors).
    // field_agent was renamed to expert; master added as top-tier headroom.
    difficulties: {
        recruit: {
            label: 'Recruit',
            color: '#4ade80',
        ...
        expert: {
            ...
            xp: 4000,
            costRange: '$15-80+',
            description: 'Field-deployable builds, complex firmware, production-grade tools.'
        },
        master: {
            label: 'Master',
            color: '#e879f9',
            xp: 8000,
            costRange: '$20-150+',
            description: 'Capstone-grade. The hardest, most integrative builds on the platform.'
        }
    },
    ...
    tracks: [
        ...
        {
            id: 'esp32-s3-arsenal',
            name: 'ESP32-S3 Arsenal',
            tagline: 'Native USB attack platform.',
            description: 'LILYGO T-Display-S3 security tools — native USB HID, WiFi recon, BLE exploitation, network impersonation, and the Custom Army Knife multi-tool.',
            icon: '../../assets/images/icons/icon-lightning.webp',
            color: '#a855f7',
    ...
    sections: [
        ...
        ,{
            ...
            color: '#06b6d4',
            projects: [
                { id: 'sg-43', title: 'Raspberry Pi Headless Setup', type: 'build', difficulty: 'recruit', platform: 'raspberry-pi', buildTime: '30m', cost: '$45', status: 'ready', href: 'sg-43-pi-headless-setup.html', skills: ['ssh', 'linux', 'networking'], prerequisites: [], parts: [{ component: 'Raspberry Pi 4/5', qty: 1, inKit: false }, { component: 'microSD Card (32GB+)', qty: 1, inKit: false }, { component: 'USB-C Power Supply', qty: 1, inKit: false }, { component: 'Ethernet Cable', qty: 1, inKit: false }], outcomes: ['Flash Raspberry Pi OS to SD card', 'Configure WiFi and SSH before first boot', 'Connect headless via SSH from any computer', 'Update and secure the base OS'] },
                { id: 'sg-44', title: 'Pi-hole DNS Ad Blocker', type: 'build', difficulty: 'recruit', platform: 'raspberry-pi', buildTime: '45m', cost: '$0', status: 'ready', href: 'sg-44-pi-hole-dns.html', skills: ['dns', 'networking', 'linux-admin'], prerequisites: ['sg-43'], parts: [{ component: 'Raspberry Pi (running)', qty: 1, inKit: false }], outcomes: ['Install and configure Pi-hole', 'Set Pi as network DNS server', 'Create custom blocklists and whitelists', 'Monitor DNS queries in the Pi-hole dashboard'] },
                { id: 'sg-45', title: 'PXE Boot Server', type: 'build', difficulty: 'operator', platform: 'raspberry-pi', buildTime: '2h', cost: '$0', status: 'ready', href: 'sg-45-pxe-boot-server.html', skills: ['pxe', 'dhcp', 'tftp', 'networking'], prerequisites: ['sg-43'], parts: [{ component: 'Raspberry Pi or Linux Server', qty: 1, inKit: false }, { component: 'Target computer with PXE support', qty: 1, inKit: false }, { component: 'Ethernet switch', qty: 1, inKit: false }], outcomes: ['Configure dnsmasq for DHCP and TFTP', 'Serve boot images over the network', 'PXE boot Ubuntu installer on a client machine', 'Understand the full PXE boot sequence'] },
        ...
        // =================================================================
        {
            ...
            projects: [
                ...
                { id: 'sg-54', title: 'ADS-B Aircraft Tracker', type: 'build', difficulty: 'recruit', platform: 'raspberry-pi', buildTime: '1h', cost: '$25', status: 'ready', href: 'sg-54-ads-b-tracker.html', skills: ['adsb', 'aviation', 'data-visualization'], prerequisites: ['sg-53'], parts: [{ component: 'RTL-SDR Dongle', qty: 1, inKit: false }, { component: '1090 MHz Antenna', qty: 1, inKit: false }, { component: 'Raspberry Pi', qty: 1, inKit: false }], outcomes: ['Receive ADS-B signals from aircraft at 1090 MHz', 'Install dump1090 decoder', 'Visualize aircraft positions on a web map', 'Feed data to FlightAware or ADS-B Exchange'] },
                ...
                { id: 'sg-61', title: 'Car Key Fob Analyzer', type: 'build', difficulty: 'specialist', platform: 'raspberry-pi', buildTime: '1.5h', cost: '$0', status: 'ready', href: 'sg-61-key-fob-analyzer.html', skills: ['rf-security', 'replay-analysis', 'rolling-codes'], prerequisites: ['sg-53', 'sg-57'], parts: [{ component: 'RTL-SDR Dongle', qty: 1, inKit: false }, { component: 'Your own car key fob', qty: 1, inKit: false }], outcomes: ['Capture 315/433 MHz key fob transmissions', 'Analyze signal structure and modulation', 'Understand rolling codes and why replay attacks fail on modern cars', 'Compare fixed-code vs rolling-code security'] },
        ...
        // =================================================================
        {
            ...
            projects: [
                ...
                { id: 'sg-69', title: 'Home Automation Security Audit', type: 'build', difficulty: 'expert', platform: 'raspberry-pi', buildTime: '3h', cost: '$0', status: 'ready', href: 'sg-69-home-audit.html', skills: ['iot-audit', 'network-scanning', 'risk-assessment'], prerequisites: ['sg-63', 'sg-64', 'sg-66'], parts: [{ component: 'Raspberry Pi with tools', qty: 1, inKit: false }, { component: 'Your own smart home devices', qty: 1, inKit: false }], outcomes: ['Inventory all IoT devices on your network', 'Scan for open ports and default credentials', 'Test for unencrypted communication channels', 'Write a security audit report with remediation steps'] },
                { id: 'sg-70', title: 'Firmware Extraction and Analysis', type: 'build', difficulty: 'expert', platform: 'raspberry-pi', buildTime: '3h', cost: '$15', status: 'ready', href: 'sg-70-firmware-extract.html', skills: ['firmware', 'binwalk', 'reverse-engineering'], prerequisites: ['sg-43'], parts: [{ component: 'IoT device with downloadable firmware', qty: 1, inKit: false }, { component: 'Linux workstation', qty: 1, inKit: false }], outcomes: ['Download firmware from manufacturer websites', 'Extract filesystem with binwalk', 'Find hardcoded credentials and API keys', 'Analyze startup scripts and service configurations'] },
        ...
        // =================================================================
        {
            ...
            projects: [
                ...
                { id: 'sg-84', title: 'Drone RF Communication Analysis', type: 'build', difficulty: 'specialist', platform: 'raspberry-pi', buildTime: '2h', cost: '$0', status: 'ready', href: 'sg-84-rf-analysis.html', skills: ['rf-analysis', 'drone-protocols', 'sdr'], prerequisites: ['sg-53', 'sg-83'], parts: [{ component: 'RTL-SDR Dongle', qty: 1, inKit: false }, { component: 'Drone (any consumer model)', qty: 1, inKit: false }], outcomes: ['Identify drone control frequencies (2.4 GHz, 5.8 GHz)', 'Capture drone telemetry with SDR', 'Analyze video downlink signals', 'Understand frequency hopping spread spectrum (FHSS)'] },
        ...
        // =================================================================
        // ESP32-S3 ARSENAL — LILYGO T-Display-S3 USB Security Tools
        // =================================================================
        {
            id: 'esp32-s3-arsenal',
            name: 'ESP32-S3 Arsenal',
            track: 'esp32-s3-arsenal',
            icon: '../../assets/images/icons/icon-lightning.webp',
            description: 'Native USB security tools on the LILYGO T-Display-S3. HID injection, WiFi recon, BLE exploitation, and the Custom Army Knife.',
            color: '#a855f7',
            projects: [
                { id: 'sg-103', title: 'T-Display-S3 Setup & Your First USB Device', type: 'build', difficulty: 'recruit', platform: 'esp32-devkit', buildTime: '60m', cost: '$18', status: 'ready', href: 'sg-103-s3-setup.html', skills: ['usb-protocol', 'arduino-ide', 'display-programming'], prerequisites: [], parts: [{ component: 'LILYGO T-Display-S3', qty: 1, inKit: false }, { component: 'USB-C Cable', qty: 1, inKit: false }], outcomes: ['Set up Arduino IDE for ESP32-S3 with TFT_eSPI', 'Display text and graphics on the built-in TFT', 'Present the board as a USB HID keyboard', 'Understand native USB OTG vs CDC mode'] },
                { id: 'sg-104', title: 'Rubber Ducky S3: Keystroke Injection', type: 'build', difficulty: 'operative', platform: 'esp32-devkit', buildTime: '90m', cost: '$0', status: 'ready', href: 'sg-104-rubber-ducky-s3.html', skills: ['usb-protocol', 'cpp', 'firmware-dev'], prerequisites: ['sg-103'], parts: [{ component: 'LILYGO T-Display-S3 (from SG-103)', qty: 1, inKit: false }], outcomes: ['Build a USB keystroke injector with payload selection', 'Write DuckyScript-compatible payloads', 'Add TFT menu for selecting payloads', 'Understand USB HID report descriptors'] },
                { id: 'sg-105', title: 'WiFi Recon Dashboard S3', type: 'build', difficulty: 'operative', platform: 'esp32-devkit', buildTime: '90m', cost: '$0', status: 'ready', href: 'sg-105-wifi-recon-s3.html', skills: ['wifi-scanning', 'display-programming', 'cpp'], prerequisites: ['sg-103'], parts: [{ component: 'LILYGO T-Display-S3 (from SG-103)', qty: 1, inKit: false }], outcomes: ['Scan and display WiFi networks with signal strength', 'Identify hidden SSIDs and security types', 'Build a portable WiFi survey tool', 'Log scan results to flash storage'] },
                { id: 'sg-106', title: 'BLE Swiss Army Scanner', type: 'build', difficulty: 'specialist', platform: 'esp32-devkit', buildTime: '2h', cost: '$0', status: 'ready', href: 'sg-106-ble-swiss-army.html', skills: ['bluetooth', 'cpp', 'display-programming'], prerequisites: ['sg-103'], parts: [{ component: 'LILYGO T-Display-S3 (from SG-103)', qty: 1, inKit: false }], outcomes: ['Scan for BLE devices and enumerate services', 'Identify device types from advertising data', 'Track BLE device presence over time', 'Build a portable BLE reconnaissance tool'] },
                { id: 'sg-107', title: 'USB Mass Storage Exfiltration Lab', type: 'build', difficulty: 'specialist', platform: 'esp32-devkit', buildTime: '2h', cost: '$5', status: 'ready', href: 'sg-107-usb-mass-storage.html', skills: ['usb-protocol', 'sd-storage', 'cpp'], prerequisites: ['sg-104'], parts: [{ component: 'LILYGO T-Display-S3 (from SG-103)', qty: 1, inKit: false }, { component: 'MicroSD Card', qty: 1, inKit: false }, { component: 'MicroSD Breakout Board', qty: 1, inKit: false }], outcomes: ['Present the S3 as a USB mass storage device', 'Combine HID + MSC for keystroke-then-exfil attacks', 'Understand USB composite device descriptors', 'Build detection countermeasures'] },
                { id: 'sg-108', title: 'Network Interface Impersonation', type: 'build', difficulty: 'specialist', platform: 'esp32-devkit', buildTime: '2h', cost: '$0', status: 'ready', href: 'sg-108-network-impersonation.html', skills: ['usb-protocol', 'networking', 'cpp'], prerequisites: ['sg-104'], parts: [{ component: 'LILYGO T-Display-S3 (from SG-103)', qty: 1, inKit: false }], outcomes: ['Present the S3 as a USB Ethernet adapter (RNDIS/ECM)', 'Intercept DNS queries via the fake network interface', 'Understand USB CDC-NCM network class', 'Build defensive detection scripts'] },
                { id: 'sg-109', title: 'WiFi Deauther Detector', type: 'build', difficulty: 'operative', platform: 'esp32-devkit', buildTime: '90m', cost: '$0', status: 'ready', href: 'sg-109-wifi-deauther-detector.html', skills: ['wifi-scanning', 'packet-capture', 'display-programming'], prerequisites: ['sg-105'], parts: [{ component: 'LILYGO T-Display-S3 (from SG-103)', qty: 1, inKit: false }], outcomes: ['Monitor WiFi for deauthentication frames', 'Display alerts with attacker MAC and target BSSID', 'Log deauth events with timestamps', 'Understand 802.11 management frame attacks'] },
