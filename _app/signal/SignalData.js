    ...
    sections: [
        ...
        // =================================================================
        {
            ...
            projects: [
                ...
                { id: 'sg-70', title: 'Firmware Extraction and Analysis', type: 'build', difficulty: 'field_agent', platform: 'raspberry-pi', buildTime: '3h', cost: '$15', status: 'ready', href: 'sg-70-firmware-extract.html', skills: ['firmware', 'binwalk', 'reverse-engineering'], prerequisites: ['sg-43'], parts: [{ component: 'IoT device with downloadable firmware', qty: 1, inKit: false }, { component: 'Linux workstation', qty: 1, inKit: false }], outcomes: ['Download firmware from manufacturer websites', 'Extract filesystem with binwalk', 'Find hardcoded credentials and API keys', 'Analyze startup scripts and service configurations'] },
