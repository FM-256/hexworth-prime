 ...
 *   ProjectsData.getByDifficulty('recruit')
...
const ProjectsData = {
    ...
    // -------------------------------------------------------------------------
    // P6: unified 6-tier ladder, geometric XP (shared with the Signal hub). Colors align to
    // Signal's existing ramp so both hubs read identically. Expert/Master are headroom for the
    // hardest builds/capstones (few projects reach them yet).
    difficulties: {
        recruit:    { label: 'Recruit',    color: '#4ade80', xp: 250  },
        operative:  { label: 'Operative',  color: '#facc15', xp: 500  },
        operator:   { label: 'Operator',   color: '#fb923c', xp: 1000 },
        specialist: { label: 'Specialist', color: '#f87171', xp: 2000 },
        expert:     { label: 'Expert',     color: '#c084fc', xp: 4000 },
        master:     { label: 'Master',     color: '#e879f9', xp: 8000 }
    },
    ...
    // -------------------------------------------------------------------------
    // Project definitions — 126 total (12 software + 16 hardware + 60 educative + 1 content + 18 "My First" starter + 1 AI capstone + 12 foundations/setup + 6 Shield GRC/Leadership).
    // -------------------------------------------------------------------------
    projects: [
        ...
        { id: 'starter-first-database',  house: 'code',       title: 'My First Database',    description: 'Create your first database, write SQL queries, and build a Python app that stores real data.',         difficulty: 'recruit', minutes: 45, xp: 250, phases: 4, careerRoles: ['software-developer'] },
        { id: 'starter-first-script',    house: 'script',     title: 'My First Script',      description: 'Write your first Bash script that organizes messy files into folders automatically.',                  difficulty: 'recruit', minutes: 30, xp: 250, phases: 4, careerRoles: ['sysadmin', 'devops-engineer'] },
        { id: 'starter-first-server',    house: 'cloud',      title: 'My First Server',      description: 'Spin up your first virtual machine, connect via SSH, and serve your first web page.',                 difficulty: 'recruit', minutes: 45, xp: 250, phases: 4, careerRoles: ['cloud-engineer', 'sysadmin'] },
        { id: 'starter-first-container', house: 'cloud',      title: 'My First Container',   description: 'Run your first Docker container, build your first image, and understand why containers matter.',      difficulty: 'recruit', minutes: 30, xp: 250, phases: 4, careerRoles: ['cloud-engineer', 'devops-engineer'] },
        { id: 'starter-first-network',   house: 'web',        title: 'My First Network',     description: 'Discover your own network — find your IP, trace a route, and understand how data travels.',           difficulty: 'recruit', minutes: 30, xp: 250, phases: 4, careerRoles: ['network-engineer'] },
        { id: 'starter-first-hack',      house: 'dark-arts',  title: 'My First Hack',        description: 'Complete your first ethical hacking challenge — scan, find, exploit, and capture the flag.',          difficulty: 'recruit', minutes: 45, xp: 250, phases: 4, careerRoles: ['penetration-tester'] },
        { id: 'starter-first-firewall',  house: 'shield',     title: 'My First Firewall',    description: 'Configure your first firewall rules — block traffic, allow services, and learn network defense.',     difficulty: 'recruit', minutes: 30, xp: 250, phases: 4, careerRoles: ['soc-analyst'] },
        { id: 'starter-first-scan',      house: 'eye',        title: 'My First Scan',        description: 'Use Nmap to scan your own network — discover hosts, identify services, see through a hacker\'s eyes.',difficulty: 'recruit', minutes: 30, xp: 250, phases: 4, careerRoles: ['penetration-tester', 'soc-analyst'] },
        { id: 'starter-first-bot',       house: 'divergent',  title: 'My First Bot',         description: 'Build your first Discord bot that responds to commands, tells jokes, and runs in your server.',       difficulty: 'recruit', minutes: 45, xp: 250, phases: 4, careerRoles: ['software-developer'] },
        { id: 'starter-first-pipeline',  house: 'code',       title: 'My First Pipeline',    description: 'Set up your first CI/CD pipeline with GitHub Actions — every push automatically tests your code.',    difficulty: 'recruit', minutes: 30, xp: 250, phases: 4, careerRoles: ['devops-engineer'] },
        { id: 'starter-first-agent',     house: 'ai',         title: 'My First Agent',       description: 'Build your first AI agent in Copilot Studio — an adaptive Level 1-5 path from a talking study assistant to an autonomous operations agent.', difficulty: 'recruit', minutes: 30, xp: 250, phases: 5, technologies: ['Microsoft Copilot Studio'], skills: ['AI agents', 'prompt design', 'tool use', 'grounding'], prerequisites: [], careerRoles: ['ai-engineer', 'devops-engineer'] },
        { id: 'starter-first-workflow',  house: 'ai',         title: 'My First Workflow',    description: 'Build your first automated workflow in Power Automate — grow one Help-Desk Intake flow across an adaptive Level 1-5 path: trigger, branching, AI, approvals, scheduled ops.', difficulty: 'recruit', minutes: 30, xp: 250, phases: 5, technologies: ['Power Automate'], skills: ['workflow automation', 'triggers', 'branching', 'approvals'], prerequisites: [], careerRoles: ['devops-engineer', 'ai-engineer'] },
        { id: 'starter-first-knowledge-base', house: 'ai',    title: 'My First Knowledge Base', description: 'Build your first knowledge base in Copilot Studio — grow one Help-Desk KB across an adaptive Level 1-5 path: ingest, organize, retrieval quality, citations and grounding guardrails, freshness. Learn how RAG grounds an AI in your sources.', difficulty: 'recruit', minutes: 30, xp: 250, phases: 5, technologies: ['Microsoft Copilot Studio'], skills: ['RAG', 'retrieval', 'grounding', 'knowledge management'], prerequisites: [], careerRoles: ['ai-engineer'] },
        ...
        { id: 'cloud-ec2-first-server',  house: 'cloud',      title: 'Launch Your First EC2 Instance', description: 'Launch your first AWS EC2 virtual server, connect over SSH, and serve a web page from the cloud.', difficulty: 'recruit', minutes: 60, xp: 250, phases: 5, careerRoles: ['cloud-engineer'] },
        { id: 'cloud-oracle-free-vm',    house: 'cloud',      title: 'Spin Up a Free Oracle Cloud VM', description: 'Provision an always-free Oracle Cloud compute VM, connect via SSH, and run your first cloud workload at no cost.', difficulty: 'recruit', minutes: 45, xp: 200, phases: 5, careerRoles: ['cloud-engineer'] },
        { id: 'cloud-s3-static-site',    house: 'cloud',      title: 'Host a Static Website on AWS S3', description: 'Host a static website on AWS S3 — create a bucket, upload your site, and serve it publicly over the web.', difficulty: 'recruit', minutes: 45, xp: 200, phases: 5, careerRoles: ['cloud-engineer'] },
        { id: 'darkarts-kali-setup',     house: 'dark-arts',  title: 'Set Up Your Kali Linux Attack VM', description: 'Build your first Kali Linux attack VM — install, configure, and verify the offensive-security toolkit in a safe, isolated lab.', difficulty: 'recruit', minutes: 60, xp: 200, phases: 5, careerRoles: ['penetration-tester'] },
        { id: 'forge-home-lab',          house: 'forge',      title: 'Build a 3-VM Home Lab', description: 'Build a 3-VM home lab on an isolated network — router, server, and client — the foundation for hands-on security practice.', difficulty: 'operative', minutes: 180, xp: 500, phases: 5, careerRoles: ['sysadmin'] },
        { id: 'forge-virtualbox-first-vm', house: 'forge',    title: 'Create Your First Virtual Machine', description: 'Create your first virtual machine in VirtualBox — install a guest OS, configure resources, and take your first snapshot.', difficulty: 'recruit', minutes: 60, xp: 200, phases: 5, careerRoles: ['sysadmin'] },
        { id: 'forge-vmware-first-vm',   house: 'forge',      title: 'Build a VM with VMware Workstation', description: 'Build your first virtual machine in VMware Workstation — install a guest OS, configure networking, and manage snapshots.', difficulty: 'recruit', minutes: 60, xp: 200, phases: 5, careerRoles: ['sysadmin'] },
        { id: 'shield-firewall-iptables', house: 'shield',    title: 'Build a Firewall with iptables', description: 'Build a working Linux firewall with iptables — write rules to allow services, block traffic, and defend a host.', difficulty: 'recruit', minutes: 60, xp: 250, phases: 5, careerRoles: ['soc-analyst'] },
        { id: 'starter-calculator',      house: 'code',       title: 'Build a Calculator App', description: 'Build your first calculator app — handle user input, perform arithmetic, and manage operations and errors.', difficulty: 'recruit', minutes: 60, xp: 200, phases: 5, careerRoles: ['software-developer'] },
        { id: 'starter-first-repo',      house: 'code',       title: 'Your First Git Repository', description: 'Create your first Git repository — initialize, commit, branch, and push your code to GitHub.', difficulty: 'recruit', minutes: 30, xp: 100, phases: 5, careerRoles: ['software-developer'] },
        { id: 'starter-github-profile',  house: 'code',       title: 'Create Your GitHub Profile README', description: 'Create a standout GitHub profile README — the special repository that introduces you to the developer world.', difficulty: 'recruit', minutes: 30, xp: 100, phases: 5, careerRoles: ['software-developer'] },
        { id: 'starter-portfolio-site',  house: 'web',        title: 'Build a Portfolio Website with GitHub Pages', description: 'Build and publish a personal portfolio website for free with GitHub Pages — show your projects to the world.', difficulty: 'recruit', minutes: 120, xp: 300, phases: 5, careerRoles: ['software-developer'] },

        // ── Shield: GRC + Security Leadership ladders (process/deliverable projects; fill the grc-analyst + security-leadership career paths) ──
        { id: 'shield-first-security-policy', house: 'shield', title: 'Write Your First Security Policy', description: 'Draft your first real security policies — an Acceptable Use Policy and a NIST-aligned password policy — and learn the anatomy, roles, and enforcement behind every governance document.', difficulty: 'recruit', minutes: 45, xp: 250, phases: 5, technologies: ['NIST 800-63B', 'SANS templates'], skills: ['policy writing', 'governance', 'enforcement'], prerequisites: [], careerRoles: ['grc-analyst'] },
        { id: 'shield-first-risk-assessment', house: 'shield', title: 'Run Your First Risk Assessment', description: 'Run a complete qualitative risk assessment — inventory assets, identify threats, score likelihood × impact, build a risk register, and propose treatments.', difficulty: 'operative', minutes: 90, xp: 500, phases: 5, technologies: ['NIST 800-30'], skills: ['risk assessment', 'risk register', 'threat modeling'], prerequisites: ['shield-first-security-policy'], careerRoles: ['grc-analyst'] },
        { id: 'shield-control-framework-mapping', house: 'shield', title: 'Map Controls to a Compliance Framework', description: "Map a system's controls to NIST CSF or ISO 27001, run a gap analysis, and write a prioritized findings report — the deliverable behind every audit.", difficulty: 'operator', minutes: 120, xp: 1000, phases: 5, technologies: ['NIST CSF', 'ISO 27001'], skills: ['compliance', 'control mapping', 'gap analysis'], prerequisites: ['shield-first-risk-assessment'], careerRoles: ['grc-analyst'] },
        { id: 'shield-awareness-program', house: 'shield', title: 'Build a Security Awareness Program', description: 'Design a security awareness program — audience segments, a training plan, a non-punitive phishing simulation, metrics, and a leadership pitch.', difficulty: 'operative', minutes: 90, xp: 500, phases: 5, technologies: ['NIST', 'SANS Security Awareness'], skills: ['security awareness', 'phishing simulation', 'metrics', 'leadership'], prerequisites: [], careerRoles: ['security-leadership'] },
        { id: 'shield-incident-response-plan', house: 'shield', title: 'Write an Incident Response Plan', description: 'Author an incident response plan per NIST 800-61 — team & authority, severity classification, the IR lifecycle, a communication plan, and a runbook.', difficulty: 'operator', minutes: 120, xp: 1000, phases: 5, technologies: ['NIST 800-61'], skills: ['incident response', 'IR planning', 'runbooks', 'leadership'], prerequisites: [], careerRoles: ['security-leadership'] },
        { id: 'shield-tabletop-exercise', house: 'shield', title: 'Lead a Tabletop Exercise', description: 'Design and facilitate a tabletop exercise, then write an after-action report that turns lessons into owned, dated improvements.', difficulty: 'specialist', minutes: 120, xp: 2000, phases: 5, technologies: ['CISA TTX'], skills: ['tabletop exercise', 'facilitation', 'after-action report', 'readiness'], prerequisites: ['shield-incident-response-plan'], careerRoles: ['security-leadership'] },
        ...
        // ── Featured Projects ──
        {
            ...
            difficulty: 'operator',
            minutes: 180,
            xp: 1000, phases: 6, careerRoles: ['ai-engineer']
        },
        {
            ...
            difficulty: 'recruit',
            minutes: 60,
            xp: 250, phases: 5, careerRoles: ['devops-engineer', 'sysadmin']
        },
        {
            ...
            minutes: 90,
            xp: 500, phases: 5, careerRoles: ['soc-analyst']
        },
        {
        ...
        },
        {
            ...
            difficulty: 'operative',
            minutes: 120,
            xp: 500, phases: 5, careerRoles: ['network-engineer']
        },
        {
            ...
            difficulty: 'operative',
            minutes: 90,
            xp: 500, phases: 5, careerRoles: ['cloud-engineer', 'devops-engineer']
        },
        {
            ...
            difficulty: 'operator',
            minutes: 120,
            xp: 1000, phases: 5, careerRoles: ['security-architect', 'appsec-engineer']
        },
        {
            ...
            difficulty: 'operative',
            minutes: 90,
            xp: 500, phases: 5, careerRoles: ['ai-engineer', 'soc-analyst']
        },
        {
            ...
            difficulty: 'operator',
            minutes: 120,
            xp: 1000, phases: 5, careerRoles: ['soc-analyst', 'data-analyst']
        },
        {
        ...
        // ── Hardware Projects: Raspberry Pi ──────────────────────────────────
        {
            ...
            difficulty: 'recruit',
            minutes: 60,
            xp: 250, phases: 5, careerRoles: ['sysadmin', 'devops-engineer']
        },
        {
            ...
            difficulty: 'operative',
            minutes: 90,
            xp: 500, phases: 5, careerRoles: ['network-engineer', 'sysadmin']
        },
        {
            id: 'cloud-pi-homelab',
            house: 'cloud',
        ...
        },
        {
            ...
            difficulty: 'operator',
            minutes: 120,
            xp: 1000, phases: 5, careerRoles: ['soc-analyst']
        },
        ...
        },
        {
            ...
            difficulty: 'operative',
            minutes: 90,
            xp: 500, phases: 5, careerRoles: ['hardware-engineer', 'security-architect']
        },
        ...
        },
        {
            ...
            difficulty: 'operator',
            minutes: 120,
            xp: 1000, phases: 5, careerRoles: ['ai-engineer', 'soc-analyst']
        },
        {
        ...
        },
        {
            ...
            difficulty: 'recruit',
            minutes: 60,
            xp: 250, phases: 5, careerRoles: ['hardware-engineer', 'soc-analyst']
        },
        {
            ...
            difficulty: 'recruit',
            minutes: 60,
            xp: 250, phases: 5, careerRoles: ['hardware-engineer', 'data-analyst']
        },
        {
        ...
        },
        {
            ...
            difficulty: 'operator',
            minutes: 120,
            xp: 1000, phases: 5, careerRoles: ['devops-engineer', 'cloud-engineer']
        },
        {
        ...
        },
        {
            ...
            difficulty: 'operative',
            minutes: 90,
            xp: 500, phases: 5, careerRoles: ['devops-engineer', 'cloud-engineer']
        },
        {
            id: 'ai-rag-chatbot',
            house: 'ai',
            ...
            difficulty: 'operative',
            minutes: 90,
            xp: 500, phases: 5, careerRoles: ['ai-engineer']
        },
        {
            ...
            difficulty: 'operative',
            minutes: 90,
            xp: 500, phases: 6, careerRoles: ['ai-engineer', 'soc-analyst']
        },
        {
            ...
            difficulty: 'operator',
            minutes: 120,
            xp: 1000, phases: 5, careerRoles: ['ai-engineer']
        },
        {
        ...
        },
        {
            ...
            difficulty: 'operative',
            minutes: 90,
            xp: 500, phases: 5, careerRoles: ['data-analyst', 'devops-engineer']
        },
        {
            ...
            difficulty: 'operative',
            minutes: 60,
            xp: 500, phases: 5, careerRoles: ['devops-engineer']
        },
        {
            id: 'matrix-data-viz',
            house: 'matrix',
            ...
            difficulty: 'recruit',
            minutes: 60,
            xp: 250, phases: 5, careerRoles: ['data-analyst']
        },
        {
            ...
            difficulty: 'operator',
            minutes: 120,
            xp: 1000, phases: 5, careerRoles: ['data-analyst', 'ai-engineer']
        },
        {
            id: 'web-rest-api',
            house: 'web',
            ...
            difficulty: 'operative',
            minutes: 90,
            xp: 500, phases: 5, careerRoles: ['software-developer']
        },
        {
            id: 'key-blockchain',
            house: 'key',
        ...
        },
        {
            ...
            difficulty: 'operator',
            minutes: 120,
            xp: 1000, phases: 5, careerRoles: ['soc-analyst', 'ai-engineer']
        },
        {
        ...
        },
        {
            ...
            difficulty: 'recruit',
            minutes: 45,
            xp: 250, phases: 5, careerRoles: ['software-developer']
        },
        {
            id: 'web-react-router',
            house: 'web',
            ...
            difficulty: 'operative',
            minutes: 90,
            xp: 500, phases: 6, careerRoles: ['software-developer']
        },
        {
            ...
            difficulty: 'operative',
            minutes: 90,
            xp: 500, phases: 6, careerRoles: ['software-developer', 'cloud-engineer']
        },
        {
            id: 'cloud-django-eks',
            house: 'cloud',
            ...
            difficulty: 'operator',
            minutes: 120,
            xp: 1000, phases: 6, careerRoles: ['devops-engineer', 'cloud-engineer']
        },
        {
            ...
            difficulty: 'operator',
            minutes: 120,
            xp: 1000, phases: 5, careerRoles: ['ai-engineer', 'data-analyst']
        },
        {
        ...
        },
        {
            ...
            difficulty: 'recruit',
            minutes: 45,
            xp: 250, phases: 5, careerRoles: ['ai-engineer']
        },
        {
            ...
            difficulty: 'operative',
            minutes: 90,
            xp: 500, phases: 5, careerRoles: ['data-analyst', 'ai-engineer']
        },
        {
            ...
            difficulty: 'operative',
            minutes: 60,
            xp: 500, phases: 5, careerRoles: ['data-analyst']
        },
        {
        ...
        },
        {
            ...
            difficulty: 'operative',
            minutes: 90,
            xp: 500, phases: 5, careerRoles: ['software-developer', 'data-analyst']
        },
        {
        ...
        },
        {
            ...
            difficulty: 'operator',
            minutes: 120,
            xp: 1000, phases: 6, careerRoles: ['software-developer', 'appsec-engineer']
        },
        {
            ...
            difficulty: 'operator',
            minutes: 120,
            xp: 1000, phases: 6, careerRoles: ['security-architect', 'software-developer']
        },
        {
            id: 'shield-fake-news',
            house: 'shield',
            ...
            difficulty: 'operative',
            minutes: 60,
            xp: 500, phases: 6, careerRoles: ['ai-engineer']
        },
        {
        ...
        },
        {
            ...
            difficulty: 'operator',
            minutes: 120,
            xp: 1000, phases: 6, careerRoles: ['devops-engineer']
        },
        {
            id: 'cloud-aws-vpc',
            house: 'cloud',
            ...
            difficulty: 'operative',
            minutes: 60,
            xp: 500, phases: 6, careerRoles: ['cloud-security-engineer', 'cloud-engineer']
        },
        {
        ...
        },
        {
            ...
            difficulty: 'operative',
            minutes: 60,
            xp: 500, phases: 5, careerRoles: ['ai-engineer', 'data-analyst']
        },
        {
        ...
        },
        {
            ...
            difficulty: 'operative',
            minutes: 60,
            xp: 500, phases: 6, careerRoles: ['data-analyst']
        },
        {
        ...
        },
        {
            ...
            difficulty: 'operative',
            minutes: 60,
            xp: 500, phases: 5, careerRoles: ['software-developer', 'appsec-engineer']
        },
        {
            ...
            difficulty: 'operative',
            minutes: 60,
            xp: 500, phases: 5, careerRoles: ['cloud-security-engineer', 'appsec-engineer']
        },
        {
