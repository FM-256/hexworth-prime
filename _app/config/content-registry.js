...
// ─── FORGE HOUSE (remaining REG-001 fixes) ───
    ...
    paths: {
        ...
        'comptia-linux': {
            ...
            icon: '<img src="/assets/images/icons/icon-penguin.webp" alt="" style="width:1.1em;height:1.1em;vertical-align:middle">',
        ...
        'python-fundamentals': {
            ...
            icon: '<img src="/assets/images/icons/icon-snake.webp" alt="" style="width:1.1em;height:1.1em;vertical-align:middle">',
            certification: null,
            difficulty: 'beginner',
            estimatedHours: 35,
            color: '#fbbf24',
    ...
    houses: {
        web: {
            ...
            shortName: 'The Web',
            icon: '<img src="/assets/images/icons/icon-spiderweb.webp" alt="" style="width:1.1em;height:1.1em;vertical-align:middle">',
