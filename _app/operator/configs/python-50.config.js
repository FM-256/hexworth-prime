/* PYTHON-50 / IRON CURTAIN — Act IV. 12x12 grid. All tools available. */
var PYTHON_50_CONFIG = {
    id: 'python-50', title: 'PYTHON-50 / IRON CURTAIN',
    subtitle: 'Part I Finale. Every tool. Every obstacle. Masterpiece.', category: 'python-ops', difficulty: 4, inputMode: 'python', agent: { tier: 3 },
    grid: { rows: 12, cols: 12, cells: [
            ['gateway','empty','fire-11','empty','enemy-9','fire-2','empty','empty','wall','empty','empty','empty'],
            ['empty','empty','wall','empty','srv-1','empty','srv-3','empty','empty','empty','empty','empty'],
            ['empty','srv-4','empty','empty','empty','empty','empty','empty','empty','empty','empty','trap-1'],
            ['empty','empty','empty','wall','empty','wall','empty','empty','hole-1','empty','empty','empty'],
            ['empty','empty','empty','empty','empty','empty','empty','enemy-3','hole-10','wall','empty','wall'],
            ['empty','empty','empty','empty','empty','empty','empty','empty','empty','fire-5','empty','empty'],
            ['empty','empty','empty','empty','empty','wall','router','empty','empty','enemy-15','wall','empty'],
            ['empty','empty','empty','empty','empty','srv-2','empty','empty','empty','wall','empty','hole-13'],
            ['empty','hole-7','empty','empty','empty','empty','empty','empty','empty','fire-8','empty','empty'],
            ['empty','empty','empty','empty','empty','empty','empty','empty','empty','empty','empty','empty'],
            ['empty','wall','empty','empty','empty','empty','wall','enemy-6','empty','empty','empty','trap-2'],
            ['empty','wall','empty','hole-4','empty','empty','enemy-12','empty','wall','fire-14','wall','target']
    ], start: { col: 0, row: 0 } },
    nodes: {
        ...
        'srv-1': { label: 'SRV-ALPHA', abbr: 'SRA', ip: '10.350.1.11', desc: 'ALPHA', ports: ['22/SSH','8080/HTTP'], os: 'Ubuntu 24.04 LTS' },        'srv-2': { label: 'SRV-BRAVO', abbr: 'SRB', ip: '10.350.1.12', desc: 'BRAVO', ports: ['22/SSH','8080/HTTP'], os: 'Ubuntu 24.04 LTS' },        'srv-3': { label: 'SRV-CHARLIE', abbr: 'SRC', ip: '10.350.1.13', desc: 'CHARLIE', ports: ['22/SSH','8080/HTTP'], os: 'Ubuntu 24.04 LTS' },        'srv-4': { label: 'SRV-DELTA', abbr: 'SRD', ip: '10.350.1.14', desc: 'DELTA', ports: ['22/SSH','8080/HTTP'], os: 'Ubuntu 24.04 LTS' },
        ...
        'trap-2': { label: 'IDS-SENSOR', abbr: 'IDS', ip: '10.350.0.201', desc: 'IDS', ports: ['514/SYSLOG'], os: 'Snort [TRAP]' }
    },
    traps: ['trap-1','trap-2'],
    ...
    integrity: 8,
    completion: { title: 'IRON CURTAIN', subtitle: 'Level 50 complete.', storageKey: 'hexworth_operator_python50' }
};
