...
const ContentCatalog = (function() {
    ...
    const MODULES = [
        ...
        // Foundation (001-005)
        { house: 'script', id: 'clh-001', title: 'CLH-001: Introduction to Hacker CLI', description: 'Begin your journey as a command line operator. Reconnaissance basics.', icon: '💀', status: 'available', components: ['presentation', 'lab', 'quiz'], href: 'courses/clh/modules/clh-001/lab.html', tags: ['clh', 'command line hacker', 'linux', 'hacking', 'terminal', 'cli', 'reconnaissance'] },
        { house: 'script', id: 'clh-002', title: 'CLH-002: Navigation & Reconnaissance', description: 'Navigate filesystems and extract intel from target directories.', icon: '🧭', status: 'available', components: ['presentation', 'lab', 'quiz'], href: 'courses/clh/modules/clh-002/lab.html', tags: ['clh', 'command line hacker', 'linux', 'recon', 'terminal', 'cli', 'navigation'] },
        { house: 'script', id: 'clh-003', title: 'CLH-003: Pattern Hunting', description: 'Hunt for hidden codes using grep and pattern matching.', icon: '🎯', status: 'available', components: ['presentation', 'lab', 'quiz'], href: 'courses/clh/modules/clh-003/lab.html', tags: ['clh', 'command line hacker', 'linux', 'grep', 'terminal', 'cli', 'regex'] },
        { house: 'script', id: 'clh-004', title: 'CLH-004: Process Investigation', description: 'Hunt suspicious processes. Find the malware hiding in the process list.', icon: '🔍', status: 'available', components: ['presentation', 'lab', 'quiz'], href: 'courses/clh/modules/clh-004/lab.html', tags: ['clh', 'command line hacker', 'linux', 'processes', 'terminal', 'cli', 'malware'] },
        { house: 'script', id: 'clh-005', title: 'CLH-005: Log Analysis', description: 'Analyze system logs. Find error patterns and document anomalies.', icon: '📋', status: 'available', components: ['presentation', 'lab', 'quiz'], href: 'courses/clh/modules/clh-005/lab.html', tags: ['clh', 'command line hacker', 'linux', 'logs', 'terminal', 'cli', 'forensics'] },
        // Operations (006-008)
        { house: 'script', id: 'clh-006', title: 'CLH-006: File Operations', description: 'Create, copy, move, and delete files during field operations.', icon: '📁', status: 'available', components: ['presentation', 'lab', 'quiz'], href: 'courses/clh/modules/clh-006/lab.html', tags: ['clh', 'command line hacker', 'linux', 'files', 'terminal', 'cli', 'mkdir', 'cp', 'mv', 'rm'] },
        { house: 'script', id: 'clh-007', title: 'CLH-007: Permissions & Access Control', description: 'Decode permission matrices and secure sensitive files.', icon: '🔐', status: 'available', components: ['presentation', 'lab', 'quiz'], href: 'courses/clh/modules/clh-007/lab.html', tags: ['clh', 'command line hacker', 'linux', 'permissions', 'terminal', 'cli', 'chmod', 'security'] },
        { house: 'script', id: 'clh-008', title: 'CLH-008: Shell Scripting Basics', description: 'Write and execute shell scripts for automated operations.', icon: '📜', status: 'available', components: ['presentation', 'lab', 'quiz'], href: 'courses/clh/modules/clh-008/lab.html', tags: ['clh', 'command line hacker', 'linux', 'scripting', 'bash', 'terminal', 'cli', 'automation'] },
        // Analysis (009-011)
        { house: 'script', id: 'clh-009', title: 'CLH-009: Text Processing', description: 'Extract and transform data using cut, sort, uniq, awk, and sed.', icon: '🔤', status: 'available', components: ['presentation', 'lab', 'quiz'], href: 'courses/clh/modules/clh-009/lab.html', tags: ['clh', 'command line hacker', 'linux', 'terminal', 'cli', 'text-processing', 'awk', 'sed', 'cut', 'sort'] },
        { house: 'script', id: 'clh-010', title: 'CLH-010: I/O Redirection', description: 'Control data streams with redirects, pipes, and tee.', icon: '🔀', status: 'available', components: ['presentation', 'lab', 'quiz'], href: 'courses/clh/modules/clh-010/lab.html', tags: ['clh', 'command line hacker', 'linux', 'terminal', 'cli', 'redirection', 'pipes', 'tee'] },
        { house: 'script', id: 'clh-011', title: 'CLH-011: Advanced Grep & Regex', description: 'Hunt patterns with grep flags and regular expressions.', icon: '🧬', status: 'available', components: ['presentation', 'lab', 'quiz'], href: 'courses/clh/modules/clh-011/lab.html', tags: ['clh', 'command line hacker', 'linux', 'terminal', 'cli', 'grep', 'regex', 'pattern-matching'] },
        // Advanced (012-015)
        { house: 'script', id: 'clh-012', title: 'CLH-012: Network Basics', description: 'Probe network connectivity with ping, netstat, ss, and ip.', icon: '🌐', status: 'available', components: ['presentation', 'lab', 'quiz'], href: 'courses/clh/modules/clh-012/lab.html', tags: ['clh', 'command line hacker', 'linux', 'terminal', 'cli', 'networking', 'ping', 'netstat'] },
        { house: 'script', id: 'clh-013', title: 'CLH-013: Environment Variables', description: 'Master shell environment with env, export, and PATH manipulation.', icon: '🔧', status: 'available', components: ['presentation', 'lab', 'quiz'], href: 'courses/clh/modules/clh-013/lab.html', tags: ['clh', 'command line hacker', 'linux', 'terminal', 'cli', 'environment', 'env', 'export', 'PATH'] },
        { house: 'script', id: 'clh-014', title: 'CLH-014: Process Control', description: 'Manage processes with ps, kill, jobs, bg, fg, and nohup.', icon: '🎛️', status: 'available', components: ['presentation', 'lab', 'quiz'], href: 'courses/clh/modules/clh-014/lab.html', tags: ['clh', 'command line hacker', 'linux', 'terminal', 'cli', 'processes', 'ps', 'kill', 'jobs'] },
        { house: 'script', id: 'clh-015', title: 'CLH-015: Capstone Mission', description: 'Final investigation. Apply all skills. Earn CLI Engineer certification.', icon: '🏆', status: 'available', components: ['presentation', 'lab', 'quiz'], href: 'courses/clh/modules/clh-015/lab.html', tags: ['clh', 'command line hacker', 'linux', 'terminal', 'cli', 'capstone', 'certification'] },
        // Tactical (016-022)
        { house: 'script', id: 'clh-016', title: 'CLH-016: System Intel', description: 'Intelligence gathering and tactical reconnaissance operations.', icon: '🛰️', status: 'available', components: ['presentation', 'lab', 'quiz'], href: 'courses/clh/modules/clh-016/lab.html', tags: ['clh', 'command line hacker', 'linux', 'terminal', 'cli', 'reconnaissance', 'system-info', 'uname'] },
        { house: 'script', id: 'clh-017', title: 'CLH-017: Find & Locate', description: 'Search and file location discovery techniques.', icon: '🗺️', status: 'available', components: ['presentation', 'lab', 'quiz'], href: 'courses/clh/modules/clh-017/lab.html', tags: ['clh', 'command line hacker', 'linux', 'terminal', 'cli', 'find', 'locate', 'search'] },
        { house: 'script', id: 'clh-018', title: 'CLH-018: Archive Operations', description: 'Dead Drop Protocol — handling and extracting intel packages.', icon: '📦', status: 'available', components: ['presentation', 'lab', 'quiz'], href: 'courses/clh/modules/clh-018/lab.html', tags: ['clh', 'command line hacker', 'linux', 'terminal', 'cli', 'tar', 'gzip', 'archives'] },
        { house: 'script', id: 'clh-019', title: 'CLH-019: Disk Forensics', description: 'Evidence Lab — digital forensics and disk image analysis.', icon: '🔬', status: 'available', components: ['presentation', 'lab', 'quiz'], href: 'courses/clh/modules/clh-019/lab.html', tags: ['clh', 'command line hacker', 'linux', 'terminal', 'cli', 'forensics', 'disk', 'df', 'du'] },
        { house: 'script', id: 'clh-020', title: 'CLH-020: User Reconnaissance', description: 'User account profiling and privilege enumeration.', icon: '👤', status: 'available', components: ['presentation', 'lab', 'quiz'], href: 'courses/clh/modules/clh-020/lab.html', tags: ['clh', 'command line hacker', 'linux', 'terminal', 'cli', 'users', 'enumeration', 'whoami'] },
        { house: 'script', id: 'clh-021', title: 'CLH-021: SSH Operations', description: 'Operation Silent Relay — secure encrypted tunnel establishment.', icon: '🔒', status: 'available', components: ['presentation', 'lab', 'quiz'], href: 'courses/clh/modules/clh-021/lab.html', tags: ['clh', 'command line hacker', 'linux', 'terminal', 'cli', 'ssh', 'tunnels', 'encryption'] },
        { house: 'script', id: 'clh-022', title: 'CLH-022: Network Reconnaissance', description: 'Infrastructure mapping and lateral movement planning.', icon: '🕸️', status: 'available', components: ['presentation', 'lab', 'quiz'], href: 'courses/clh/modules/clh-022/lab.html', tags: ['clh', 'command line hacker', 'linux', 'terminal', 'cli', 'networking', 'recon', 'lateral-movement'] },
        // Black Ops (023-027)
        { house: 'script', id: 'clh-023', title: 'CLH-023: Service Management', description: 'Compromised server audit — identifying malicious services.', icon: '⚙️', status: 'available', components: ['presentation', 'lab', 'quiz'], href: 'courses/clh/modules/clh-023/lab.html', tags: ['clh', 'command line hacker', 'linux', 'terminal', 'cli', 'services', 'systemctl', 'audit'] },
        { house: 'script', id: 'clh-024', title: 'CLH-024: Scheduled Tasks', description: 'Persistence Hunt — cron jobs and system timers.', icon: '⏰', status: 'available', components: ['presentation', 'lab', 'quiz'], href: 'courses/clh/modules/clh-024/lab.html', tags: ['clh', 'command line hacker', 'linux', 'terminal', 'cli', 'cron', 'crontab', 'persistence'] },
        { house: 'script', id: 'clh-025', title: 'CLH-025: Package Management', description: 'Supply chain audit — package verification and integrity.', icon: '📥', status: 'available', components: ['presentation', 'lab', 'quiz'], href: 'courses/clh/modules/clh-025/lab.html', tags: ['clh', 'command line hacker', 'linux', 'terminal', 'cli', 'apt', 'dpkg', 'packages'] },
        { house: 'script', id: 'clh-026', title: 'CLH-026: Access Control', description: 'Vault Security Review — hunting privilege escalation vectors.', icon: '🛡️', status: 'available', components: ['presentation', 'lab', 'quiz'], href: 'courses/clh/modules/clh-026/lab.html', tags: ['clh', 'command line hacker', 'linux', 'terminal', 'cli', 'sudo', 'privilege-escalation', 'access-control'] },
        { house: 'script', id: 'clh-027', title: 'CLH-027: User Management', description: 'Identity Management — user account administration.', icon: '👥', status: 'available', components: ['presentation', 'lab', 'quiz'], href: 'courses/clh/modules/clh-027/lab.html', tags: ['clh', 'command line hacker', 'linux', 'terminal', 'cli', 'useradd', 'usermod', 'groups'] },
        // Ghost Tier (028-031)
        { house: 'script', id: 'clh-028', title: 'CLH-028: System Monitoring', description: 'Threat Hunt — active incident response with real-time monitoring.', icon: '📡', status: 'available', components: ['presentation', 'lab', 'quiz'], href: 'courses/clh/modules/clh-028/lab.html', tags: ['clh', 'command line hacker', 'linux', 'terminal', 'cli', 'monitoring', 'top', 'incident-response'] },
        { house: 'script', id: 'clh-029', title: 'CLH-029: Vim Essentials', description: 'Master the modal editor of legends.', icon: '📝', status: 'available', components: ['presentation', 'lab', 'quiz'], href: 'courses/clh/modules/clh-029/lab.html', tags: ['clh', 'command line hacker', 'linux', 'terminal', 'cli', 'vim', 'editor'] },
        { house: 'script', id: 'clh-030', title: 'CLH-030: OPERATION CHIMERA', description: 'High-stakes mission at maximum classification level.', icon: '🔥', status: 'available', components: ['presentation', 'lab', 'quiz'], href: 'courses/clh/modules/clh-030/lab.html', tags: ['clh', 'command line hacker', 'linux', 'terminal', 'cli', 'capstone', 'operation'] },
        { house: 'script', id: 'clh-031', title: 'CLH-031: Operation BLACKOUT', description: 'Final operation — the ultimate test of everything you have learned.', icon: '🖤', status: 'available', components: ['lab'], href: 'courses/clh/modules/clh-031/lab.html', tags: ['clh', 'command line hacker', 'linux', 'terminal', 'cli', 'final', 'operation'] },
