...
const ContentCatalog = (function() {
    ...
    const MODULES = [
        ...
        { house: 'eye', id: 'eye-dont-feed-the-troll', title: "Don't Feed the Troll", description: 'OSINT survival game. Hacktivists are doxing your C-suite. Use threat intelligence techniques to track the source, protect executives, and catch the insider before the data dump goes live.', icon: '🎮', status: 'available', components: ['game', 'lab'], href: 'games/dont-feed-the-troll.html', tags: ['game', 'survival', 'osint', 'threat-intel'] },
        { house: 'eye', id: 'eye-alert-triage', title: 'Alert Triage', description: 'SOC analyst simulator. Classify security alerts as True Positive, False Positive, or Escalate. 15 realistic alerts with brute force, phishing, ransomware, and insider threat scenarios.', icon: '👁️', status: 'available', components: ['game'], href: 'games/alert-triage.html', tags: ['game', 'soc', 'alert-triage', 'monitoring'] },
        { house: 'eye', id: 'eye-memory-forensics', title: 'Memory Forensics', description: 'Volatility-style memory dump analysis. Examine process tables to identify malware, rootkits, RATs, credential dumpers, and cryptominers.', icon: '🧠', status: 'available', components: ['game'], href: 'games/memory-forensics.html', tags: ['game', 'forensics', 'memory', 'volatility', 'malware'] },
        { house: 'eye', id: 'eye-threat-modeler', title: 'Threat Modeler', description: 'STRIDE methodology threat modeling. Analyze system architectures, identify threat categories, and recommend mitigations.', icon: '🎯', status: 'available', components: ['game'], href: 'games/threat-modeler.html', tags: ['game', 'threat-modeling', 'stride', 'architecture'] },
        { house: 'eye', id: 'eye-grep-noir', title: 'grep -rn', description: 'DOS-style text adventure. Hardboiled digital forensics noir. A CEO is framed — examine disk images, memory dumps, network captures. Multiple endings.', icon: '🔎', status: 'available', components: ['game'], href: 'games/grep-noir.html', tags: ['game', 'adventure', 'forensics', 'investigation'] },
        ...
        { house: 'script', id: 'script-dont-kill-the-server', title: "Don't Kill the Server", description: 'Linux sysadmin survival game. Production web server disk is full during Black Friday. Fix it using real Linux commands in 3 minutes.', icon: '🎮', status: 'available', components: ['game', 'lab'], href: 'games/dont-kill-the-server.html', tags: ['game', 'survival', 'linux', 'sysadmin', 'troubleshooting'] },
        { house: 'script', id: 'script-sudo-su', title: 'sudo su', description: 'DOS-style text adventure. Linux sysadmin discovers a rootkit on a production server. Hunt the intruder through the filesystem using real commands. Multiple endings.', icon: '💀', status: 'available', components: ['game'], href: 'games/sudo-su.html', tags: ['game', 'adventure', 'rootkit', 'forensics', 'linux'] },
        { house: 'script', id: 'script-shell-sprint', title: 'Shell Sprint', description: '8-bit pixel endless runner. Terminal cursor sprinting through a Linux filesystem. Jump over permission errors, duck under segfaults, dodge fork bombs.', icon: '🐚', status: 'available', components: ['game'], href: 'games/shell-sprint.html', tags: ['game', 'runner', 'pixel', 'arcade', 'linux', 'terminal'] },
        ...
        { house: 'forge', id: 'forge-dont-brick-the-pc', title: "Don't Brick the PC", description: 'Malware incident on a user workstation. Contain the threat before ransomware deploys across the network. Type Windows commands under pressure.', icon: '🎮', status: 'available', components: ['game', 'lab'], href: 'games/dont-brick-the-pc.html', tags: ['game', 'survival', 'malware', 'windows', 'incident-response'] },
        { house: 'forge', id: 'forge-dont-anger-the-printer', title: "Don't Anger the Printer", description: 'The C-suite printer has gone rogue. Fix it before the board meeting.', icon: '🎮', status: 'available', components: ['game', 'lab'], href: 'games/dont-anger-the-printer.html', tags: ['game', 'survival', 'printer', 'hardware', 'troubleshooting'] },
        { house: 'forge', id: 'forge-raid-calculator', title: 'RAID Calculator', description: 'RAID level selection and storage calculation challenge. Select correct RAID levels and calculate capacity across 10 scenarios.', icon: '💽', status: 'available', components: ['game'], href: 'games/raid-calculator.html', tags: ['game', 'raid', 'storage', 'hardware', 'calculation'] },
        { house: 'forge', id: 'forge-fsck', title: 'fsck', description: 'DOS-style text adventure. Trapped in a failing data center — power dying, drives failing, cooling down, halon armed. Fix 6 server racks before the countdown ends.', icon: '🔧', status: 'available', components: ['game'], href: 'games/fsck.html', tags: ['game', 'adventure', 'disaster', 'hardware', 'datacenter'] },
        { house: 'forge', id: 'forge-bit-dash', title: 'Bit Dash', description: '8-bit pixel endless runner. Binary bit racing through motherboard traces. Jump over bad sectors, duck under power surges, dodge static discharge.', icon: '🏃', status: 'available', components: ['game'], href: 'games/bit-dash.html', tags: ['game', 'runner', 'pixel', 'arcade', 'hardware', 'binary'] },
        ...
        { house: 'web', id: 'web-dont-drop-the-packet', title: "Don't Drop the Packet", description: 'Network engineer survival game. Core switch firmware update went wrong. STP loops forming, VLANs misconfigured. Fix it using Cisco IOS commands in 3 minutes.', icon: '🎮', status: 'available', components: ['game', 'lab'], href: 'games/dont-drop-the-packet.html', tags: ['game', 'survival', 'network', 'cisco', 'stp', 'vlan'] },
        { house: 'web', id: 'web-packet-sniffer', title: 'Packet Sniffer', description: 'Wireshark-style packet capture analysis. Examine network traffic and answer questions about protocols, port scans, DNS queries, and suspicious traffic.', icon: '🦈', status: 'available', components: ['game'], href: 'games/packet-sniffer.html', tags: ['game', 'wireshark', 'packet-analysis', 'network'] },
        { house: 'web', id: 'web-network-architect', title: 'Network Architect', description: 'Drag-and-drop topology builder. Design network architectures with routers, switches, firewalls, and servers. 8 levels from simple LAN to full enterprise.', icon: '🏗️', status: 'available', components: ['game'], href: 'games/network-architect.html', tags: ['game', 'design', 'topology', 'network', 'architecture'] },
        { house: 'web', id: 'web-wireless-warzone', title: 'Wireless Warzone', description: 'WiFi security monitoring simulator. Detect rogue access points, evil twins, deauth attacks, and WPA handshake captures.', icon: '📶', status: 'available', components: ['game'], href: 'games/wireless-warzone.html', tags: ['game', 'wifi', 'wireless', 'security', 'monitoring'] },
        { house: 'web', id: 'web-nmap', title: 'nmap', description: 'DOS-style text adventure. Explore a corporate network like a dungeon crawler. Discover hosts, exploit vulnerabilities, and map the topology without triggering the IDS.', icon: '🗺️', status: 'available', components: ['game'], href: 'games/nmap.html', tags: ['game', 'adventure', 'nmap', 'reconnaissance', 'network'] },
        { house: 'web', id: 'web-packet-run', title: 'Packet Run', description: '8-bit pixel endless runner. You are a network packet dodging firewalls, IDS sensors, malware, and DDoS floods. Chiptune soundtrack and progressive difficulty.', icon: '📦', status: 'available', components: ['game'], href: 'games/packet-run.html', tags: ['game', 'runner', 'pixel', 'arcade', 'network'] },
        ...
        { house: 'shield', id: 'shield-dont-get-phished', title: "Don't Get Phished", description: 'SOC analyst survival game. A spear-phishing campaign is hitting C-suite inboxes. Use SIEM and IR commands under pressure before the CEO opens his email.', icon: '🎮', status: 'available', components: ['game', 'lab'], href: 'games/dont-get-phished.html', tags: ['game', 'survival', 'phishing', 'soc', 'incident-response'] },
        { house: 'shield', id: 'shield-sql-injection-defense', title: 'SQL Injection Defense', description: 'WAF analyst training. Classify incoming SQL queries as legitimate or malicious, identify injection types, and fix vulnerable code.', icon: '💉', status: 'available', components: ['game'], href: 'games/sql-injection-defense.html', tags: ['game', 'waf', 'sql-injection', 'appsec', 'defense'] },
        { house: 'shield', id: 'shield-malware-zoo', title: 'Malware Zoo', description: 'Malware classification and analysis trainer. Examine behavioral indicators, network signatures, and file artifacts to identify malware families.', icon: '🦠', status: 'available', components: ['game'], href: 'games/malware-zoo.html', tags: ['game', 'malware', 'analysis', 'classification'] },
        { house: 'shield', id: 'shield-social-engineer', title: 'Social Engineer', description: 'Social engineering defense simulator. Identify attack types, spot red flags, and choose correct responses across phishing, vishing, smishing, and pretexting scenarios.', icon: '🎭', status: 'available', components: ['game'], href: 'games/social-engineer.html', tags: ['game', 'social-engineering', 'defense', 'awareness'] },
        { house: 'shield', id: 'shield-incident', title: '--incident', description: 'DOS-style text adventure. SOC analyst on night shift when every SIEM alert goes red. Contain the breach or watch it burn. Multiple endings.', icon: '🚨', status: 'available', components: ['game'], href: 'games/incident-response.html', tags: ['game', 'adventure', 'incident-response', 'soc'] },
        { house: 'shield', id: 'shield-tor', title: 'tor', description: 'DOS-style text adventure. OSINT investigator tracking a ransomware gang through darkweb forums, crypto mixers, and encrypted chats. Multiple endings.', icon: '🧅', status: 'available', components: ['game'], href: 'games/tor-darkweb.html', tags: ['game', 'adventure', 'osint', 'darkweb', 'investigation'] },
        { house: 'shield', id: 'shield-threat-runner', title: 'Threat Runner', description: '8-bit pixel endless runner. SOC analyst sprinting through cyber threats. Jump over ransomware, duck under phishing hooks, dodge zero-days.', icon: '🛡️', status: 'available', components: ['game'], href: 'games/threat-runner.html', tags: ['game', 'runner', 'pixel', 'arcade', 'threats', 'soc'] },
        ...
        { house: 'key', id: 'key-dont-leak-the-key', title: "Don't Leak the Key", description: 'Cryptography survival game. Someone committed the ROOT PRIVATE KEY to a public GitHub repo. Revoke certs, rotate keys, and save the banking portal.', icon: '🎮', status: 'available', components: ['game', 'lab'], href: 'games/dont-leak-the-key.html', tags: ['game', 'survival', 'crypto', 'pki', 'incident-response'] },
        { house: 'key', id: 'key-cipher-cracker', title: 'Cipher Cracker', description: 'Decrypt intercepted transmissions using progressively harder ciphers. Caesar, Atbash, Substitution, Vigenere, and XOR.', icon: '🔑', status: 'available', components: ['game'], href: 'games/cipher-cracker.html', tags: ['game', 'crypto', 'ciphers', 'decryption', 'cryptanalysis'] },
        { house: 'key', id: 'key-gpg-decrypt', title: 'gpg --decrypt', description: 'DOS-style text adventure. Spy thriller climbing the Cryptographers Tower. 8 floors of real crypto puzzles — Caesar, Vigenere, XOR, RSA, AES. Multiple endings.', icon: '🔑', status: 'available', components: ['game'], href: 'games/gpg-decrypt.html', tags: ['game', 'adventure', 'crypto', 'rsa', 'aes'] },
        ...
        { house: 'cloud', id: 'cloud-dont-lose-your-domain', title: "Don't Lose Your Domain", description: 'A fired employee has Domain Admin and is still on VPN. Type PowerShell commands to save your domain in 3 minutes.', icon: '🎮', status: 'available', components: ['game', 'lab'], href: 'games/dont-lose-your-domain.html', tags: ['game', 'survival', 'active-directory', 'powershell'] },
        { house: 'cloud', id: 'cloud-dont-check-the-bill', title: "Don't Check the Bill", description: 'The intern launched 200 GPU instances. Your AWS bill is $847,000 and climbing. Stop the bleeding before the credit card maxes out.', icon: '🎮', status: 'available', components: ['game', 'lab'], href: 'games/dont-check-the-bill.html', tags: ['game', 'survival', 'aws', 'cost-management'] },
        { house: 'cloud', id: 'cloud-iam-debugger', title: 'IAM Policy Debugger', description: 'Fix misconfigured AWS IAM policies. Identify wildcard abuse, privilege escalation, missing conditions, and cross-account leaks.', icon: '🔐', status: 'available', components: ['game'], href: 'games/iam-debugger.html', tags: ['game', 'iam', 'aws', 'policy', 'security'] },
        { house: 'cloud', id: 'cloud-ad-attack-path', title: 'AD Attack Path', description: 'BloodHound-style Active Directory privilege escalation. Map attack paths through misconfigured trusts, delegation, and GPOs.', icon: '🏰', status: 'available', components: ['game'], href: 'games/ad-attack-path.html', tags: ['game', 'activedirectory', 'privilege-escalation', 'bloodhound'] },
        { house: 'cloud', id: 'cloud-cloud-architect', title: 'Cloud Architect', description: 'AWS infrastructure design challenge. Build cloud architectures meeting availability, security, and cost requirements.', icon: '☁️', status: 'available', components: ['game'], href: 'games/cloud-architect.html', tags: ['game', 'aws', 'architecture', 'infrastructure'] },
        { house: 'cloud', id: 'cloud-aws-sts', title: 'aws sts', description: 'DOS-style text adventure. Cloud Heist — crypto miners burning $500/minute across your AWS accounts. Chase through IAM roles, Lambda, and EC2. Multiple endings.', icon: '💰', status: 'available', components: ['game'], href: 'games/aws-sts.html', tags: ['game', 'adventure', 'aws', 'iam', 'incident-response'] },
        { house: 'cloud', id: 'cloud-cloud-hop', title: 'Cloud Hop', description: '8-bit pixel platformer-runner. Container pod hopping between AWS, Azure, and GCP cloud platforms. Avoid outages, dodge misconfigs, survive multi-cloud chaos.', icon: '🌤️', status: 'available', components: ['game'], href: 'games/cloud-hop.html', tags: ['game', 'runner', 'pixel', 'arcade', 'cloud', 'multi-cloud'] },
        ...
        { house: 'code', id: 'code-dont-deploy-on-friday', title: "Don't Deploy on Friday", description: 'DevOps survival game. You force-pushed untested code to production at 4:55 PM on Friday. Use git, kubectl, and docker to save your career.', icon: '🎮', status: 'available', components: ['game', 'lab'], href: 'games/dont-deploy-on-friday.html', tags: ['game', 'survival', 'devops', 'git', 'kubernetes'] },
        { house: 'code', id: 'code-pipeline-panic', title: 'Pipeline Panic', description: 'Drag-and-drop CI/CD pipeline builder under time pressure. Arrange stages in correct order across 8 rounds of increasing complexity.', icon: '🔧', status: 'available', components: ['game'], href: 'games/pipeline-panic.html', tags: ['game', 'cicd', 'pipeline', 'devops'] },
        { house: 'code', id: 'code-git-bisect', title: 'Git Bisect', description: 'Find the breaking commit using binary search through git history. Inspect diffs, mark commits as good or bad. 8 rounds from easy to hard.', icon: '🔀', status: 'available', components: ['game'], href: 'games/git-bisect.html', tags: ['game', 'git', 'debugging', 'devops'] },
        { house: 'code', id: 'code-docker-escape', title: 'Docker Escape Room', description: 'Container breakout puzzle game. Exploit Docker misconfigurations like privileged mode, mounted sockets, and capability abuse. 8 levels.', icon: '🐳', status: 'available', components: ['game'], href: 'games/docker-escape.html', tags: ['game', 'docker', 'containers', 'security'] },
        { house: 'code', id: 'code-kubernetes-rescue', title: 'Kubernetes Rescue', description: 'kubectl troubleshooting simulator. Debug failing pods, fix CrashLoopBackOff errors, resolve image pull issues, and repair broken deployments.', icon: '☸️', status: 'available', components: ['game'], href: 'games/kubernetes-rescue.html', tags: ['game', 'kubernetes', 'k8s', 'troubleshooting'] },
        { house: 'code', id: 'code-git-blame', title: 'git blame', description: 'DOS-style text adventure. Supply chain attack in your CI/CD pipeline. Race the deploy clock through git history to find the poisoned dependency. Multiple endings.', icon: '👆', status: 'available', components: ['game'], href: 'games/git-blame.html', tags: ['game', 'adventure', 'supply-chain', 'security'] },
        { house: 'code', id: 'code-kill-nine', title: 'kill -9', description: 'DOS-style text adventure. The AI Uprising — your ML model went rogue. Debug training data, investigate data poisoning, stop the model before it ships. Multiple endings.', icon: '⚡', status: 'available', components: ['game'], href: 'games/kill-nine.html', tags: ['game', 'adventure', 'ai', 'ml'] },
        { house: 'code', id: 'code-pod-crossing', title: 'Pod Crossing', description: 'Frogger style game navigating Kubernetes pods across network traffic and deployment pipelines', icon: '☸️', status: 'available', components: ['game'], href: 'games/pod-crossing.html', tags: ['game', 'arcade', 'frogger', 'kubernetes', 'devops'] }
    ];
