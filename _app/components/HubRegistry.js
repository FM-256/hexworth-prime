...
(function (root) {
    ...
    var HUBS = [
        ...
        { id: 'cse',             origin: 'derived',     category: 'cert-prep', catalogCode: 'CSE v1', label: 'Cloud Security Engineer', sublabel: 'EC-Council CSE', icon: '/assets/images/icons/icon-cloud.webp',  hubHref: '/houses/cloud/cse/index.html',              parent: 'cloud-master', tenantAssignable: true, house: 'cloud', sortOrder: 628 },
        { id: 'openstack',       origin: 'derived',     category: 'course', label: 'OpenStack Cloud',          sublabel: 'Live Cloud Labs', icon: '/assets/images/icons/icon-cloud.webp',    hubHref: '/houses/cloud/openstack/index.html',          catalogCategories: ['openstack'], parent: 'cloud-master', tenantAssignable: true, house: 'cloud', sortOrder: 120 },
