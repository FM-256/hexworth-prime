...
(function (root) {
    ...
    var HUBS = [
        ...
        { id: 'comptia-network', origin: 'derived',      category: 'cert-prep', catalogCode: 'N10-009', label: 'CompTIA Network+ Cert Path', sublabel: 'N10-009', icon: '/assets/images/icons/icon-network.webp',  hubHref: '/houses/comptia-network/index.html',      tenantAssignable: true, house: 'web',    sortOrder: 231 },
