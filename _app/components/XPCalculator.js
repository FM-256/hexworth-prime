...
const XPCalculator = (function () {
    ...
    function _isValidId(id) {
        ...
        /* LAB TRACKER KEYS ARE VALID IDS, NOT GARBAGE. BUG-267, second and larger half.
           ...
           LOCALSTORAGE completedModules array, which no server snapshot can see, so how many students
           this actually hit is NOT measurable from here. An earlier version of this comment claimed
           "one production account was already at 14" -- that was FALSE. That account's
           modulesCompleted was EMPTY; the 14 was its labsCompleted total, which is never scanned.
