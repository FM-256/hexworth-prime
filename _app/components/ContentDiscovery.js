...
const ContentDiscovery = (function() {
    ...
    const PLATFORM_HUBS = [
        ...
        { name: 'FORENSICS HUB',       desc: 'Digital Investigation',       icon: '/assets/images/icons/icon-detective.webp',           fallback: '/assets/images/icons/icon-microscope.webp', href: 'houses/eye/forensics/index.html' },
