...
const ContentDiscovery = (function() {
    ...
    // PLATFORM HUBS -- RETIRED 2026-07-28.
    // This file used to ship a 15-card PLATFORM_HUBS grid that renderPlatformHubs()
    // injected into every house's Explore All tab, and a comment here declared it
    // "complementary" to HouseRenderer's Special Features grid, warning against removing
    // either as a duplicate. In practice the panel carried THREE overlapping lists of the
    // same hubs, and both hand-written ones had drifted off the registry -- their Cortex
    // and Algorithm Chamber cards pointed at legacy paths that are no longer where those
    // hubs live. Hub cards now come from HubRegistry via HouseRenderer's EXPLORE_HUBS
    // shelf, so names, links and covers cannot drift. Do not add a hub list to this file.
