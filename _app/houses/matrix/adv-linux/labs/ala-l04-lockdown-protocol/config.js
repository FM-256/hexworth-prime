    ...
    commands: {
        ...
        'iptables': function(args, term, engine) {
            ...
            if (target === 'LOG') {
                ...
                term.fs['/'].children.var.children.log.children['cell-firewall.log'].content +=
        ...
        'iptables-save': function(args, term, engine) {
            ...
            if (outputFile.includes('rules.v4') || outputFile.includes('/etc/iptables')) {
                term.fs['/'].children.etc.children.iptables.children['rules.v4'] = {
                    type: 'file',
                    content: saveContent
                };
                return '';
        ...
        'iptables-restore': function(args, term, engine) {
            ...
            if (!term.fs['/'].children.etc.children.iptables.children['rules.v4']) {
