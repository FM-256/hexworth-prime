...
**Module slug:** `search-data-outside-azure-platform-cognitive-search`
**Source:** https://learn.microsoft.com/en-us/training/modules/search-data-outside-azure-platform-cognitive-search/
**Units:** 6

## Table of Contents

1. Introduction
2. Index data from external data sources using Azure Data Factory
3. Index any data using the Azure AI Search push API
4. Exercise: Add to an index using the push API
5. Module assessment
6. Summary
...
- Select Ingest .
- Select Next . Note You can choose to schedule the pipeline if your data is changing and you need to keep your index up-to-date. For this example, you'll import the data once.
Select Next .
Note
...
- Once the pipeline has been validated and deployed, select Finish .
...
Which feature of the REST API would you use to upload documents into a search index?
Index.
Indexer.
Skillset.
Which response code will require you to implement a backoff strategy?
200 and 201.
404 and 501.
207 and 503.
