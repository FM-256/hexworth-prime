...
**Module slug:** `introduction-computer-vision`
**Source:** https://learn.microsoft.com/en-us/training/modules/introduction-computer-vision/
**Units:** 9

## Table of Contents

1. Introduction
2. Computer vision tasks and techniques
3. Images and image processing
4. Convolutional neural networks
5. Vision transformers and multimodal models
6. Image generation
7. Exercise - Explore a computer vision scenario
8. Module assessment
9. Summary
...
Tip
For more information, see What is Azure Vision? .
