...
const ETHL08Config = {
    ...
    codeConflict: {
        provision1: 'PMI 2.1',
        provision2: 'ACM 2.3',
        conflictDescription: 'PMI 2.1 requires that professionals not allow material misrepresentations to stand in communications to stakeholders. Facebook\'s public characterization of its internal research as "inconclusive" while possessing consistent internal findings pointing to specific harms is a material misrepresentation -- one that Haugen was in a position to know about and could have corrected.\n\nACM 2.3 directs computing professionals to know and respect existing rules pertaining to their professional work, including the policies and procedures of their organization, and to challenge rules judged unethical through existing channels before violating them. The organizational procedure at Facebook was to let Product leadership make decisions about whether research recommendations were implemented. That procedure produced a documented outcome: the recommendations were not implemented.\n\nThe conflict: when the organizational procedure for resolving professional concerns is the same procedure that produced the violation of PMI 2.1, can ACM 2.3\'s "challenge through existing channels" requirement coexist with PMI 2.1? At what point does following the internal procedure become complicity in the misrepresentation? At what point does the "compelling ethical justification" carve-out of ACM 2.3 activate, permitting external action despite the procedural-floor rule? The Haugen case forces a direct confrontation with the question of whether internal channels can ever be fully "exhausted" when the person who would need to act on an escalation is the same person who approved the original decision to suppress the research.'
    },
