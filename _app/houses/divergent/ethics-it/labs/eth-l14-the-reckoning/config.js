...
const ETHL14Config = {
    ...
    stakeholders: [
        ...
        { id: 'S16', name: 'Apex\'s Outside Janitorial-Services Vendor', obvious: false, irrelevant: true }
    ],
    minStakeholders: 6,
