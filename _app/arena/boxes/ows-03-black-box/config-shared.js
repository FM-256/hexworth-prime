...
const BlackBoxConfig = {
    ...
    evidence: {
        ...
        'api-github-key':      { title: 'API: Key Exposed in Public GitHub Repo', detail: 'API key sk_live_4eC39HqLyjWDar... found in pacific-coast-carriers/fleet-integration repo. Committed Oct 2025, never rotated.', source: 'api', category: 'digital' },
