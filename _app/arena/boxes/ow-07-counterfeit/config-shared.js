...
const CounterfeitConfig = {
    ...
    evidence: {
        ...
        'at-ministry-ip':    { title: 'IP Geolocation: Ministry Building', detail: 'IP 185.47.xx.xx geolocates to 33 Lubyanka Square — a government ministry building. The admin account accessed the campaign dashboard from inside the building.', source: 'attribution', category: 'physical' },
