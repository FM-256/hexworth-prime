...
const ColdHorizonMissions = {
        ...
        2: {
            ...
            corroborators: [
                { id: 'badge-log',
              earnedBy: { kind: 'terminal', command: 'tm BADGE', establishes: 'the holder was not in the building, which no record derived from the IdP could ever say' }, name: 'Facility access control, ops floor',
        ...
        3: {
            ...
            corroborators: [
                { id: 'range-fix',
              earnedBy: { kind: 'terminal', command: 'ranging', establishes: 'a round trip you measured, which is a physical bound no moved clock can forge' }, name: 'Two-way ranging fix, modem-measured',
        ...
        4: {
            ...
            corroborators: [
                ...
                { id: 'hsm-attest',
              earnedBy: { kind: 'terminal', command: 'sdls', establishes: 'what the HSM will attest to, separately from what the token claims' }, name: 'HSM attestation log',
...
Object.assign(ColdHorizonMissions, {
    ...
    8: {
        ...
        corroborators: [
            ...
            { id: 'cable-map',
              earnedBy: { kind: 'drone', establishes: 'what is physically plugged in, counted at the rack rather than read from a map' }, name: 'Physical cable inventory, hand-recorded',
    ...
    9: {
        ...
        corroborators: [
            { id: 'layer-hash',
              earnedBy: { kind: 'terminal', command: 'tm LAYER-HASH', establishes: 'the digest actually running, not the tag that points at it' }, name: 'Running container layer digest, read on the host',
    ...
    10: {
        ...
        corroborators: [
            ...
            { id: 'downlink-tape',
              earnedBy: { kind: 'terminal', command: 'tm TAPE', establishes: 'a write-once ground recording that the platform cannot reach to amend' }, name: 'Ground downlink recording, write-once', value: 'SHOWS 58.9 C AT 06:09Z', unit: '',
    ...
    11: {
        ...
        corroborators: [
            ...
            { id: 'replay-harness',
              earnedBy: { kind: 'terminal', command: 'tm REPLAY', establishes: 'what the model does on corrected inputs, which its own logs cannot tell you' }, name: 'Offline replay against the corrected inputs',
    ...
    12: {
        ...
        corroborators: [
            { id: 'ir-survey',
              earnedBy: { kind: 'drone', establishes: 'a temperature you integrated yourself, at range, on the actual panels' }, name: 'Your own infrared survey of the three panels',
...
Object.assign(ColdHorizonMissions, {
    ...
    13: {
        ...
        corroborators: [
            ...
            { id: 'c-fsw',
              earnedBy: { kind: 'satellite', command: 'tc SAFE_MODE', establishes: 'what the flight software really does when told to safe, observed not assumed' }, name: 'Flight software safing behaviour', value: 'AUTO-SHEDS AT 71 C', unit: '',
    ...
    14: {
        ...
        corroborators: [
            ...
            { id: 'r-evidence-seal',
              earnedBy: { kind: 'terminal', command: 'tm SEAL', establishes: 'a hash fixed at capture, so later disagreement is about the record not the bundle' }, name: 'Evidence bundle hash, sealed at capture',
              value: 'INTACT', unit: '',
    ...
    15: {
        ...
        corroborators: [
            ...
            { id: 'ep-tls',
              earnedBy: { kind: 'terminal', command: 'tm TLS-FP', establishes: 'the fingerprint on the wire, which beats an opinion about the wire' }, name: 'TLS certificate fingerprint observed on the wire',
...
Object.assign(ColdHorizonMissions, {
    ...
    5: {
        ...
        corroborators: [
            ...
            { id: 'gs-uplink',
              earnedBy: { kind: 'satellite', command: 'tc PING_UPLINK', establishes: 'which station actually radiated, rather than which one is listed as able to' }, name: 'Uplink transmit log for this station', value: 'CARRIED THE FRAME, DID NOT ORIGINATE IT', unit: '',
    ...
    6: {
        ...
        corroborators: [
            ...
            { id: 'ch-rf-topology',
              earnedBy: { kind: 'drone', establishes: 'three named channels terminating on one front end, seen with your own optics' }, name: 'RF chain topology diagram', value: 'PRIMARY, BACKUP AND RELAY SHARE THE Ka FRONT END', unit: '',
    ...
    7: {
        ...
        corroborators: [
            { id: 'kvm-sel',
              earnedBy: { kind: 'terminal', command: 'tm BMC-SEL', establishes: 'a plane the host cannot see, and therefore cannot have edited' }, name: 'Management processor event log', value: 'VIRTUAL MEDIA MOUNTED 05:58Z', unit: '',
