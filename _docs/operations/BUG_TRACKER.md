...
### BUG-007 — Double-XP: `trackProgress:true` + `onComplete→completeQuiz` double-award  ·  P2  ·  fixed-not-deployed (operator ACCEPTED both residuals 2026-07-21: ship as-is, no banner change, no backfill)
