...
const BASE=process.env.BASE, OUT=process.env.OUT, Y=parseInt(process.env.Y||'0',10);
(async()=>{
 ...
 if(Y){ await p.evaluate(y=>window.scrollTo(0,y),Y); await new Promise(r=>setTimeout(r,900)); }
