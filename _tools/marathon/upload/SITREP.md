...
**Auto-updated:** 2026-08-08 00:20 EDT | branch: master | dirty files: 103
...
## NOW: Trial Run PARKED — M1/M2/M3 passed, M4 needs 3 humans. Hosting deferred by choice.
  ...
  ! THIS DIRECTORY IS NOT IN GIT. `git rev-parse` from carreer_launchpad/ says "not a git
    repository". The whole product — API, prompts, fixtures, tests, every gate artifact —
    has NO history and NO recovery point. Same shape as the _tools/ problem in CLAUDE.md,
    but a whole product. Fix this before anything else Trial Run related.
