...
**Auto-updated:** 2026-08-24 12:17 EDT | branch: master | dirty files: 54

### Latest commits (auto)
- 2ca2951bf Capstone: the objectives showed no numbers while the prose argued about 25 and 28
- 30c388fac The packets described a cloud that no longer exists, and a safety guard that never did
- fb4c2b5ab Sprint page: six openstack commands with no terminal to run them in
- c4acf71c5 The Cloud Security Sprint existed only as Word documents; put it in the hub
- c2eac6a7b Capstone check 25 graded students on a schema the page never showed them
<!-- AUTO:END -->

**Manual section updated:** 2026-08-24 evening. Read the evening block FIRST.
