...
**Auto-updated:** 2026-08-20 10:37 EDT | branch: master | dirty files: 48

### Latest commits (auto)
- 481d79cdd Spec the tournament capture + recap idea, with the blocker found by proving it
- c15645007 SITREP: tournament fixes are DEPLOYED, and three stale "NOT DEPLOYED" warnings cleared
- d251b7425 SITREP: full handover at 99% context - one deploy pending, everything else verified
...
**Manual section updated:** 2026-08-20 10:30 EDT - OpenStack claim outage FIXED on bc2 (root cause below).
...
⚠ `claim_service.py` lives ONLY on bc2 - it is not in this repo, so this fix is not in git.

## ★★★ HANDOVER 2026-08-20 02:40 - READ THIS FIRST.

### NOTHING IS PENDING. Everything below is deployed, verified and pushed.
