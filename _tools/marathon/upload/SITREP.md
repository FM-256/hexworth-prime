...
**Auto-updated:** 2026-08-10 20:30 EDT | branch: master | dirty files: 109

### Latest commits (auto)
- 258dda142 Drive NEC[1], the half of every gate that had zero coverage
- 5c12a3589 SITREP: #306 disarmed, two arms and two Chris blocks, all from asserted-not-tested claims
- 7f846d016 Derive every gated mission's case, and stop asserting the wrong invariant
- e12428660 One bucket per axis AND value, so an invited comparison cannot poison a claim
- b3e29b5cc set() does not expand dot notation, and my gate test could not fail
<!-- AUTO:END -->
