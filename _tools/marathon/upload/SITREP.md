...
**Auto-updated:** 2026-08-07 01:09 EDT | branch: master | dirty files: 99
...
- aba0b16c5 ch25: Domain 4, and drop a legacy-key call copied from the deck it was lifted from
<!-- AUTO:END -->
...
## NOW: ch25 COMPLETE and LIVE (deck + lab + quiz). Lab improvements at Chris round 2.
  ...
  LAB IMPROVEMENTS (built, NOT deployed, Chris round 2 in flight)
    ...
    FIXED by pinning LAB.dbVmId at creation (same mechanism as labVmId) AND requiring every
    db-named guest isolated, so neither creation order works. 7 new assertions reproduce
    Chris's repro with positive and negative controls.
