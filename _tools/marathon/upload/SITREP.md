...
**Auto-updated:** 2026-08-15 21:12 EDT | branch: master | dirty files: 44
...
**Manual section updated:** 2026-08-15 (handoff at 99%; write primitive + fixture + CCC done; composability open).
...
## ★ NOW: CHAOS — Phase 1 code complete. Repo @ df48884 pushed to tntxtra/chaos. 381 checks.
   Host bc4: /opt/chaos + /opt/oss-crs. HANDOFF AT 99% CONTEXT — read this before restarting work.
...
### NEXT (specified, not built)
   1. Run libxml2 through run_v01_campaign.py so the write finding enters the record/CCC/history.
