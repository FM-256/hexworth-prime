...
**Auto-updated:** 2026-08-24 21:41 EDT | branch: master | dirty files: 45
...
- a90a55a77 cinder-live: same four layout defects as the capstone, same treatment
- 6bc6dcea1 The dock shrank the console where it was not pinned, and covered the closing section
<!-- AUTO:END -->
...
## BUG-058 CLOSED: the cinder lab's check 6 now grades what it claims (2026-08-25)
...
**Not deployed:** commits `231145d86` (8-lab layout) + `d8225021e` (check 6 objective text)
are committed and gated but NOT on hexworth.com yet.
