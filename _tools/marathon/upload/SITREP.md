...
**Auto-updated:** 2026-08-08 15:20 EDT | branch: master | dirty files: 103

### Latest commits (auto)
- 74c96ed21 SITREP: spec gaps closed, M3 re-verified with the guard, OpenAI proven
...
**Manual section updated:** 2026-08-08 17:05 EDT — gpt-5-mini FAILED M2; every gate number is n=1.
...
### EVERY M2 NUMBER EVER PUBLISHED HERE IS n=1, INCLUDING OPUS'S
  ...
  OUTSTANDING: Opus not yet re-run under it — this machine holds NO ANTHROPIC_API_KEY
  (server is BYOK, carries none). Export the key and run:
      .venv/bin/python tests/test_m2_gate.py --model claude-opus-5 --runs 3
