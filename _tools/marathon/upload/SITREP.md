...
**Auto-updated:** 2026-08-11 13:13 EDT | branch: master | dirty files: 113

### Latest commits (auto)
- 42abd9f2d Clear the dash gate: 78 em-dashes in observatory, only one of them mine
- 51d80869b Minimize stops discarding a drag it never caused
- 6d680cef7 Chris's second pair: a drag that defeated Maximize, and a page my tests never opened
- a2d41b196 Fix both of Chris's blocks: a resize that resized nothing, and a manual that lied
- 35c731d3c The console stops pretending it is a shell, and stops pointing at the wrong manual
<!-- AUTO:END -->

**Manual section updated:** 2026-08-11 17:30 EDT. Rig sandbox sizing + Lagrange console: LIVE.
