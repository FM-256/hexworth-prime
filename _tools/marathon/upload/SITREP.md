...
**Auto-updated:** 2026-08-08 14:13 EDT | branch: master | dirty files: 103

### Latest commits (auto)
- 0e5a98c52 SITREP: live QC run, two blockers fixed, manual and roadmap written
...
**Manual section updated:** 2026-08-08 14:40 EDT — spec gaps CLOSED, M3 re-verified, docs written.
...
### OPENAI NOW PROVEN ON A SUCCESSFUL CALL (gap carried several rounds)
  Live gpt-5-mini through the real client: _strictify() schema accepted, tokens logged,
  and the load-bearing case CORRECT — a METHOD claim on a PASSED lab graded `unsupported`.
  n=1, NOT a gate. gpt-5-mini stays UNMEASURED until M2 is run against it.

### GATE STATE (all measured on claude-opus-5)
  M1 PASSED · M2 recall 1.000, agreement 0.946 · M3 grounded 40/40, one-question 38/40,
  zero quote-backs · M4 NOT RUN.
