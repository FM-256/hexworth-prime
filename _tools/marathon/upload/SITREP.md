...
**Auto-updated:** 2026-08-20 01:59 EDT | branch: master | dirty files: 48

### Latest commits (auto)
- 5d9140129 Tournament QC: fix the double-credit race and the unenforced visible flag
- 0d082995b SITREP: power loss #2 recovered, all pushed, tourney QC in flight
...
**Manual section updated:** 2026-08-20 02:30 EDT - HANDOVER at 99% context. Tournament scoring fixes COMMITTED, NOT DEPLOYED.

## ★★★ HANDOVER 2026-08-20 02:30 - READ THIS FIRST. Written at 99% context.

### ⚠ THE ONE THING PENDING: tournament scoring fixes are COMMITTED but NOT DEPLOYED
Commit `5d9140129` changes `ctfSubmitFlag`. Deploy with:
```
_tools/eduscan/smoke/deploy.sh --only functions
```
Nothing else is waiting. Everything before it is deployed and verified.
