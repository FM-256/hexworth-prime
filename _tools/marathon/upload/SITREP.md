...
**Auto-updated:** 2026-08-12 23:48 EDT | branch: master | dirty files: 40

### Latest commits (auto)
- b49d519aa BUG-104 (labs 2 and 3): same re-derivation, thresholds copied not tightened
- 15ba1b2c9 Add the returning-student case to the lab credit test
- b253c1803 BUG-104 (1 of 3 labs): re-derive lab credit instead of trusting a counter
- 60078c66f BUG-106 RESOLVED: verified on production, and two harness defects fixed on the way
- 3860f2233 Correct the record: the legacy branch is inert, not live protection
<!-- AUTO:END -->

**Manual section updated:** 2026-08-12. NOW: BUG-104, lab credit. 2 of 3 labs FIXED AND LIVE;
advanced-ops is STILL EXPLOITABLE on production and not deployed. Next: Chris on labs 2+3
(retroactive for launch-vm, which shipped unreviewed, see below), then deploy advanced-ops.
BUG-100/101/103/106 all live and production-verified. Course completion itself is done.

## ⏳ BUG-104: LAB CREDIT WAS HANDED OUT FOR NOTHING. 2 of 3 labs fixed and live.
   ...
   PRODUCTION, exploit run against hexworth.com:
     install      credited=false set=0   PASS
     launch-vm    credited=false set=0   PASS
     advanced-ops credited=true  set=10  STILL EXPLOITABLE, not deployed
...
## ⏳ BUG-106 (P1): THE HUB COUNTED A FAILED QUIZ AS COMPLETED. Found by Nancy, AFTER the
   ...
   and their percentage, go backwards. Operator accepted. Deploy blocked pending Chris.
