...
**Auto-updated:** 2026-08-18 19:46 EDT | branch: master | dirty files: 46

### Latest commits (auto)
- e80ed6313 Service monitor: ask whether things WORK, plus an off-site watchdog outside the power domain
- 325232754 "All servers up" was true and did not mean all services were up — 2 more were down
- 4c157f555 Power loss: all 5 servers up, and two defects that made self-recovery impossible
- 41a86183b OpenStack labs: 4-day outage from one missing port in a tailnet grant, fixed and verified
- 8f90748ec HANDOFF: CHAOS parked clean, and a near-miss found while writing it down
<!-- AUTO:END -->

**Manual section updated:** 2026-08-18 — service monitor built (probe + off-site watchdog); prometheus had not scraped bc1/bc2 for 4 days.
...
## ★ NOW 2026-08-18 — SERVICE MONITOR BUILT. It asks the student's question, not "does it ping".
