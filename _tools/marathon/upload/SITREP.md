...
**Auto-updated:** 2026-08-08 11:06 EDT | branch: master | dirty files: 102
...
## NOW: Trial Run is feature-complete for M4. M4 needs 3 humans and a consent call.
  ...
  Tests: ./run-tests.sh   — 11 offline suites, no key needed, all passing
...
### TRAPS WORTH REMEMBERING
  ...
  - OpenAI and Google clients are structurally correct but NEVER RUN LIVE (no keys here).
    One real session each before anyone trusts them.
