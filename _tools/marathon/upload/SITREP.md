...
**Auto-updated:** 2026-08-23 18:42 EDT | branch: master | dirty files: 48
...
- 81cef171f End-to-end test found the real blocker: instances have NO internet, so apt cannot install
- c7dbf9a15 Handout: the troubleshooting table still told students to use m1.nano and cited the old 192MB quota
- 422c83b08 Make the Cloud Security Sprint a repeatable event: provisioner, preflight, runbook
<!-- AUTO:END -->

**Manual section updated:** 2026-08-23 - Sprint is RUNNABLE end to end. Read the 08-23 block first,
then 08-22 (capacity/image detail), then the 08-21 ledger, then 08-20.
