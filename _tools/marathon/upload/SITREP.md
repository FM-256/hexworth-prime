...
**Auto-updated:** 2026-08-22 19:13 EDT | branch: master | dirty files: 48

### Latest commits (auto)
- 79006ca5f BUG-123 resolved and deployed; it does NOT unblock BUG-122 phase 2
- 69c3af8c8 BUG-123: stop setAdminClaim erasing a non-admin's handler claim at every sign-in
- bbc7ac299 Log BUG-122 (users enumeration, phase 1 deployed) and BUG-123 (the claim erases itself)
- 9b5970b15 firestore: close users enumeration (phase 1). GET tightening held back, it breaks 3 instructors
- c1183daba Take the uid as an argument, and move two evidence records out of the public repo
<!-- AUTO:END -->

**Manual section updated:** 2026-08-22 - OpenStack capacity DOUBLED + Ubuntu image live; see the
CLOUD SECURITY SPRINT block immediately below, then the 08-21 ledger, then 08-20.

## 2026-08-22: the Cloud Security Sprint is now DELIVERABLE. Capacity and image both fixed.
