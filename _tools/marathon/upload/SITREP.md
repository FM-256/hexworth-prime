...
**Auto-updated:** 2026-08-10 14:30 EDT | branch: master | dirty files: 108

### Latest commits (auto)
- 0af916c4f Build the two walk-downs instead of crediting a survey that saw neither
- 5f24594a5 Every level now makes you go and get the evidence
- f470eb22d A cold-open check that only knows WHERE you landed cannot see a broken page
- 2f5a8c0b2 SITREP: flight engine extracted, two commits awaiting deploy
- 1d878afe1 Extract the flight engine, so mission 2 is a config and not a copy
<!-- AUTO:END -->

**Manual section updated:** 2026-08-10 14:40 EDT. MISSION ACTS built. Levels now require moving something.
