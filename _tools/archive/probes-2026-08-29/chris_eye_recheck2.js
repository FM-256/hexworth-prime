...
(async () => {
  ...
  if (card) { await card.asElement().click(); await new Promise(r=>setTimeout(r,300)); }
  const result = await page.evaluate(() => {
    ...
    return { steps, overflowX, bodyScrollWidth: document.body.scrollWidth, viewportWidth: window.innerWidth };
  });
